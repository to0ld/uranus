...
public class CrudTestCase {
	...
	public void simple() {
		...
		try {
			...
			client.start();
			CrudTestCase.create(client,"/a","soso".getBytes(),CreateMode.EPHEMERAL);
			CrudTestCase.guaranteedDelete(client, "/a");
		} catch (Exception e) {
	 ...
	 * @throws Exception
	 */
	public static void create(CuratorFramework client, String path, byte[] payload, CreateMode mode) throws Exception {
		if (mode == null) {
	...
	public static void create(CuratorFramework client, String path, byte[] payload) throws Exception {
		create(client, path, payload, null);
	}
