...
@Service("service/pf/log/op/redis")
public class OpLogServiceRedisImpl implements OpLogService {
	@Autowired
	@Qualifier("redisTemplate")
	protected RedisTemplate<String, JSONObject> operations;
	...
	public void log(String op_cate, JSONObject jo, SecuritySession session) throws BusinessError {
		try {
			...
			operations.opsForList().rightPush(COLL_OPLOG, t);
		} catch (Exception e) {
