 ...
 *
 */
@ContextConfiguration(locations={"classpath:/spring/app.test.multiplexed.xml"})
public class ThriftServerMultiplexedTestCase extends AbstractTestNGSpringContextTests {
//	@Autowired
